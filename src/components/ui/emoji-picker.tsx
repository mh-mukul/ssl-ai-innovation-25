...
function EmojiPickerSearch({
  ...
  return (
    <div
      className={cn("flex h-8 items-center gap-2 border-b px-3", className)}
      data-slot="emoji-picker-search-wrapper"
    >
      <SearchIcon className="size-4 shrink-0 opacity-50" />
      <EmojiPickerPrimitive.Search
        className="outline-none focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-muted-foreground flex h-7 w-full rounded-md bg-transparent py-1 text-sm disabled:cursor-not-allowed disabled:opacity-50"
